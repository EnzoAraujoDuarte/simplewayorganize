...
const Legend: React.FC = () => {
  const legendItems = [
    ...
    { label: 'Vice-Presidente', color: 'linear-gradient(135deg, #7c2d12, #92400e)' },
    { label: 'Diretor', color: 'linear-gradient(135deg, #7c3aed, #6d28d9)' },
    { label: 'Gerente Sênior', color: 'linear-gradient(135deg, #059669, #047857)' },
    { label: 'Gerente', color: 'linear-gradient(135deg, #0891b2, #0e7490)' },
    { label: 'Supervisor', color: 'linear-gradient(135deg, #4b5563, #374151)' },
    { label: 'Analista Sênior', color: 'linear-gradient(135deg, #1d4ed8, #1e40af)' },
    { label: 'Analista Pleno', color: 'linear-gradient(135deg, #2563eb, #1d4ed8)' },
    { label: 'Analista Júnior', color: 'linear-gradient(135deg, #3b82f6, #2563eb)' },
